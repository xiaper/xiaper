...
(function () {
    ...
    var contentHtml = '<div id="byteDesk-app-wrapper" style="display: none">\n' +
        ...
        '                                        </div>\n' +
        '                                        <div v-if="is_type_voice(message)" class="byteDesk-text">\n' +
        '                                            <img src="/img/input/voice_received.png" alt="[语音]" style="padding-top: 10px; padding-bottom: 10px; width: 25px; height: 40px;" @click="voiceClicked(message.voice_url)"/>\n' +
        '                                        </div>\n' +
        '\n' +
